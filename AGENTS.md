# Agent guidance – wp-module-marketplace

This file gives AI agents a quick orientation to the repo. For full detail, see the **docs/** directory.

## What this project is

- **wp-module-marketplace** – A module for rendering product data and interacting with the Hiive marketplace API. Registers with the Newfold Module Loader; depends on wp-module-data. Maintained by Newfold Labs.

- **Stack:** PHP 7.3+. See docs/dependencies.md.

- **Architecture:** Registers with the loader; provides marketplace product data and API integration. See docs/integration.md.
